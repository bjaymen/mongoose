...
const personOne = new contactlist({
    name : "Aymen",
    age : 22,
    favoriteFoods : ["Lobster Thermidor", "Sesame and Coriander Crusted Basa", "Sarson Ki Gilawat with Corn and Cheese Tostadas"]
})
...
const people = [
    {
        name : "baha",
        age : 32,
        favoriteFoods : ["pizza", "mlawi","chapati"]
    },{
        name : "mohamed",
        age : 18,
        favoriteFoods : ["pizza"]
        ...
        name : "maha",
        age : 25,
        favoriteFoods : ["burritos", "pasta","hendi"]
    },{
        name : "sonia",
        age : 21,
